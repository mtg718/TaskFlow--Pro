...
@Component({
  ...
  template: `
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition-shadow duration-300">
        <div class="flex items-center">
          <div class="flex-shrink-0">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-500 uppercase tracking-wider">High Priority</p>
            <p class="text-2xl font-bold text-gray-900">{{ stats().highPriority }}</p>
          </div>
        </div>
      </div>
    </div>
